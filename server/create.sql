...
insert into boardColumn (id_boardColumn, id_board, name, has_estimative) values (2, 1, 'Coluna B', true);
insert into boardColumn (id_boardColumn, id_board, name, has_estimative) values (3, 1, 'Coluna C', true);
